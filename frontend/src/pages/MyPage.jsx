...
const MyPage = () => {
    ...
    useEffect(() => {
        ...
        const fetchMyInfo = async () => {
            try {
                ...
                const response = await api.get(`/auth/me?loginId=${currentId}`);
                setUserInfo({
                    ...response.data,
                    password: ''
                });
        ...
        // 🌟 2. 커리큘럼 DB 데이터 불러오기 함수 추가
        const fetchCurriculum = async () => {
            try {
                // 백엔드 API 명세에 맞춰 엔드포인트 수정 (예: /api/subjects)
    ...
    const isStaff = userInfo.userType === 'STAFF' || userInfo.userType === '교직원';
    ...
    const handleUpdateProfile = async () => {
        ...
        try {
            ...
            await api.put('/auth/update-password', submitData);
        ...
        <div style={styles.pageBackground}>
            <div style={styles.container}>
                ...
                <div style={styles.header}>
                    ...
                    <button onClick={() => navigate('/')} style={styles.mainButton}>메인페이지</button>
                </div>
                ...
                <div style={styles.mainContent}>
                    ...
                    <div style={styles.rightContent}>
                        ...
                        {/* 3. 학생 전용: 성적 관리 (DB 데이터 연동 대비 리스트 구조화) */}
                        ...
                        {/* 🌟 5. 교직원 전용: 커리큘럼 관리 (DB 데이터 연동 렌더링) */}
